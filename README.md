...
1) Pedir al usuario que ingrese su edad. Si es mayor o igual a 16 años, imprimí en pantalla: ¡¡Ya podes tener tu licencia de manejar!!
...
5) Pedir al usuario que ingrese su nombre. Mostrar en pantalla el nombre exactamente así: “¡Hola, [Nombre]!” (obviamente sin los corchetes).
...
7) Pedir al usuario que ingrese un año. Si el año es bisiesto, imprimir en pantalla “El año [año] es bisiesto.”. Si no lo es, imprimí “El año [año] no es bisiesto.”.

8) Pedir al usuario un número del 1 al 7. Por cada número, imprimir qué día de la semana es (1: lunes, 2: martes, y así).

9) Pedir al usuario en qué mes está (1 al 12). Si es 1, 2, ó 3, imprimir “Es verano”. Si es 4, 5 ó 6, imprimir “Es otoño”. Si es 7, 8, ó 9, imprimir “Es invierno”. Si es 10, 11, ó 12, imprimir “Es primavera”.
